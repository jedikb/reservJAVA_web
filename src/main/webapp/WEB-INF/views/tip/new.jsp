...
<form method="post" action="insert.tip" enctype="multipart/form-data">
<table>
	<tr>
		<th class='w-px140'>제목</th>
		<td><input type="text" id='board_subject' name='board_subject' title='제목' class='chk'/></td>
	</tr>
	<tr>
		<th>작성자</th>
	...
	<tr>
		<th>내용</th>
		<td><textarea id="summernote" name='board_content' class='chk' title='내용'></textarea> </td>
	</tr>
	<tr>
		<th>파일첨부</th>
		<td class='left'>
...
<a class='btn-empty' href='list.tip'>취소</a>
